...
public class CategoryProcessor {
    ...
    public static Pair<JsonObject, TypeSpec.Builder> process(TouchPortalPluginAnnotationsProcessor processor, RoundEnvironment roundEnv, Element pluginElement, Plugin plugin, Element categoryElement) throws GenericHelper.TPTypeException, TPAnnotationException {
        ...
        TypeSpec.Builder subCategoriesTypeSpecBuilder = TypeSpec.classBuilder("SubCategories").addModifiers(Modifier.PUBLIC, Modifier.STATIC);
        ...
        for (Category.SubCategory subCategory : category.subCategories()) {
            ...
            subCategoriesTypeSpecBuilder.addType(subCategoriesResult.second.build());
        }
        categoryTypeSpecBuilder.addType(subCategoriesTypeSpecBuilder.build());
